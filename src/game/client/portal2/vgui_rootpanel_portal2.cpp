...
public:
	C_SDKRootPanel( vgui::VPANEL parent, int slot, const char *pPanelName = "SDK Root Panel" );
...
//-----------------------------------------------------------------------------
C_SDKRootPanel::C_SDKRootPanel( vgui::VPANEL parent, int slot, const char *pPanelName )
	: BaseClass( NULL, pPanelName ), m_nSplitSlot( slot )
{
	SetParent( parent );
...
void VGUI_CreateClientDLLRootPanel( void )
{
	...
	g_pFullscreenRootPanel = new C_SDKRootPanel( enginevgui->GetPanel( PANEL_CLIENTDLL ), 0, "SDK Root Panel (Fullscreen)" );
